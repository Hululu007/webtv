...
使用方式：把本文档（必要时连同 `templates/extensions/` 目录）和目标网站 URL 一起交给 AI，即可直接产出可用的扩展脚本。本文档自包含扩展开发所需的全部 API 与规则；WebHome 单文件主页开发、网盘检测细节、性能改造长文见 `docs/应用完整开发文档.md`（下称"主文档"），本文按需交叉引用。本仓库中主文档位于项目根目录的 `docs/应用完整开发文档.md`。
